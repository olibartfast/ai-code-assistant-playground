...
| **Windsurf**| IDE/IDE Plugin            | Cloud/local hybrid for code suggestions, with improved local model support.                                                                                     | [Website](https://codeium.com/)                                                                                                                                                                       |
...
| **Ampcode (Sourcegraph)**         | IDE Plugin/CLI            | Context-aware assistant leveraging project-wide codebases for precise suggestions.                                                                              | [Website](https://sourcegraph.com/cody)                                                                                                                                                               |
...
| **ForgeCode**                  | IDE/Agent/CLI             | Free + Pro tiers. intelligent code optimization, smarter and faster workflows.                                      |                                                                                                                                                         |
